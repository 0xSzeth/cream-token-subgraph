...
export class SetBreaker extends ethereum.Event {
  get params(): SetBreaker__Params {
    return new SetBreaker__Params(this);
  }
}

export class SetBreaker__Params {
  _event: SetBreaker;

  constructor(event: SetBreaker) {
    this._event = event;
  }
...
export class IceCream__lockedResult {
  value0: BigInt;
  value1: BigInt;
...
export class IceCream__point_historyResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class IceCream__user_point_historyResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class IceCream extends ethereum.SmartContract {
  static bind(address: Address): IceCream {
    return new IceCream("IceCream", address);
  }
  ...
  locked(arg0: Address): IceCream__lockedResult {
    let result = super.call("locked", "locked(address):(int128,uint256)", [
      ethereum.Value.fromAddress(arg0)
    ]);

    return new IceCream__lockedResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_locked(arg0: Address): ethereum.CallResult<IceCream__lockedResult> {
    ...
    return ethereum.CallResult.fromValue(
      new IceCream__lockedResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  point_history(arg0: BigInt): IceCream__point_historyResult {
    let result = super.call(
      "point_history",
    ...
    return new IceCream__point_historyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_point_history(
    arg0: BigInt
  ): ethereum.CallResult<IceCream__point_historyResult> {
    let result = super.tryCall(
      "point_history",
      "point_history(uint256):(int128,int128,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IceCream__point_historyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  user_point_history(
    arg0: Address,
    arg1: BigInt
  ): IceCream__user_point_historyResult {
    let result = super.call(
      "user_point_history",
    ...
    return new IceCream__user_point_historyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_user_point_history(
    arg0: Address,
    arg1: BigInt
  ): ethereum.CallResult<IceCream__user_point_historyResult> {
    let result = super.tryCall(
      "user_point_history",
      "user_point_history(address,uint256):(int128,int128,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IceCream__user_point_historyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
...
export class Set_breakerCall extends ethereum.Call {
  get inputs(): Set_breakerCall__Inputs {
    return new Set_breakerCall__Inputs(this);
  }

  get outputs(): Set_breakerCall__Outputs {
    return new Set_breakerCall__Outputs(this);
  }
}

export class Set_breakerCall__Inputs {
  _call: Set_breakerCall;

  constructor(call: Set_breakerCall) {
    this._call = call;
  }
...
export class Set_breakerCall__Outputs {
  _call: Set_breakerCall;
