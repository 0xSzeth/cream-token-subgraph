...
export class Cream__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Cream extends ethereum.SmartContract {
  static bind(address: Address): Cream {
    return new Cream("Cream", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Cream__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Cream__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Cream__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Cream__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
